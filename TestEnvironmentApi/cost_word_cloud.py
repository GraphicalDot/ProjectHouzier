...
class CostWordCloudApiHelper:
        def __init__(self, **kwargs):
                ...
                self.cost_classifier = joblib.load("{0}/{1}".format(path_in_memory_classifiers, 
        ...
        def predict_sub_tags(self):
                print "Going to predict cost sub tags"
                self.cost_tags = self.cost_classifier.predict(self.c_sentences)
                return 
        ...
        def make_sentences_dict(self):
                ...
                for __sent, __sentiment, __category in zip(self.c_sentences, self.predicted_sentiment, self.cost_tags):
