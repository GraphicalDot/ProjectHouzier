...
class HeuristicClustering:
        def __init__(self, sentiment_nps, sentences, __eatery_name=None):
                """ 
                Args:
                    sentiment_nps:
                ...
                self.sentiment_nps = sentiment_nps
                ...
                self.without_clusters =  set.symmetric_difference(set(range(0, len(self.keys))), set(flatten(self.clusters)))
        ...
        def merge_similar_elements(self):
                ...
                Result:
                    ...
                    u'ice tea': {'positive', 6, 'negative': 5, "neutral": 5, "super-positive": 0, "super-negative": 10},
                    u'iced tea': {'positive', 2, 'negative', 10, "neutral": 230, "super-positive": 5, "super-negative": 5},
                }
                """
                
                without_similar_elements = dict()
                for (sentiment, noun_phrases) in self.sentiment_nps:
                        for __np in noun_phrases:
                                ...
                                if without_similar_elements.get(__np):
                                        ...
                                        new_frequency_super_positive = (super_positive, super_positive+1)[sentiment == "super-positive"]
                                        new_frequency_super_negative = (super_negative, super_negative+1)[sentiment == "super-negative"]
                                
                                        without_similar_elements.update(
                                            {__np: 
                                                {"negative": new_frequency_negative, "positive": new_frequency_positive,
                                                    "neutral": new_frequency_neutral, "super-positive": new_frequency_super_positive, 
...
if __name__ == "__main__":
        ...
        ins = HeuristicClustering(__list)
